...
const Team = () => {
  ...
  if (show) {
    ...
    button = <button onClick={()=> setShow(!show)    
    } className="text-white text-3xl color p-3 rounded-lg">Show less</button>;
    priyanka = <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 p-4 md:p-8 pt-4'>
    ...
    button = <button onClick={()=> setShow(!show)} className="text-white text-3xl color p-3 rounded-md"> Show More</button>;
    priyanka = <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 p-4 md:p-8 pt-4'>
